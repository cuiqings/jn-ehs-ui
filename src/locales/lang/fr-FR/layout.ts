export default {
  ...
  header: {
    // user dropdown
    dropdownItemDoc: '官网',
    dropdownItemLoginOut: 'Système de sortie',
    ...
    home: 'page de garde',
    welcome: 'Bienvenue sur la plateforme de gestion intelligente pour la sécurité de la production',
    logo: 'Plateforme de gestion intelligente de la production de sécurité',
  },
  multipleTab: {
    reload: '重新加载',
    close: '关闭当前',
  ...
  setting: {
    ...
    operatingTitle: 'Opération réussie',
