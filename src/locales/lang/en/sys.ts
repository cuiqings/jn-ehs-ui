export default {
  ...
  login: {
    ...
    title: 'Safety production management platform',
    welcome: 'Welcome to log in',
    nav: 'Safety production management platform',
    userNameorWorkNumber: 'Account number or work number',
  },
};
