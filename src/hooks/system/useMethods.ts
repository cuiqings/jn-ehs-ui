...
export function useMethods() {
   ...
   * @param url
   */
  async function exportXls(name, url, selectedRowKeys, params, isXlsx = false) {
   ...
   */
  async function importXls(data, url, success, dataBody) {
    ...
    await defHttp.uploadFile({ url }, { file: data.file, data: dataBody }, { success: isReturn });
  }

  return {
    handleExportXls: (name: string, url: string, params?: object, selectedRowKeys?) => exportXls(name, url, selectedRowKeys, params),
    handleImportXls: (data, url, success, dataBody?) => importXls(data, url, success, dataBody),
    handleExportXlsx: (name: string, url: string, params?: object, selectedRowKeys?) => exportXls(name, url, selectedRowKeys, params, true),
  };
}
