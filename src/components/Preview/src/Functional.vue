<script lang="tsx">
  ...
  import downloadSvg from '/@/assets/svg/preview/download.svg';
  ...
  export default defineComponent({
    ...
    setup(props, { expose, emit }) {
      ...
      function handleDownload() {
        if (imgState.currentUrl) {
          const filename = `image_${Date.now()}.jpg`;
          downloadByOnlineUrl(imgState.currentUrl, filename);
        }
      }
      ...
      const renderController = () => {
        return (
          <div class={`${prefixCls}__controller`}>
            ...
            <div class={`${prefixCls}__controller-item`} onClick={handleDownload}>
              <img src={downloadSvg} />
            </div>
      ...
      return () => {
        return (
          imgState.show && (
            <div style="z-index: 8999;" class={prefixCls} ref={wrapElRef} onMouseup={handleMouseUp} onClick={handleMaskClick}>
