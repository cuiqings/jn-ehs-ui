...
import ETreeSelectOrg from './ehs/components/ETreeSelectOrg.vue';
import ESelectInputOrg from './ehs/components/ESelectInputOrg.vue';
import JTreeSelect1 from './jeecg/components/JTreeSelect1.vue';
import ETreeSelectOrg1 from './jeecg/components/ETreeSelectOrg1.vue';
import JButtonModal from './jeecg/components/JButtonModal.vue';
import JUserModal from './jeecg/components/JUserModal.vue';
...
componentMap.set('ETreeSelectOrg', ETreeSelectOrg);
componentMap.set('ESelectInputOrg', ESelectInputOrg);
componentMap.set('JTreeSelect1', JTreeSelect1);
componentMap.set('ETreeSelectOrg1', ETreeSelectOrg1);
componentMap.set('JButtonModal', JButtonModal);
componentMap.set('JUserModal', JUserModal);
