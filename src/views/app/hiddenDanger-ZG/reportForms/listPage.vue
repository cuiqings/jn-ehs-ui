...
<script lang="ts" setup>
  ...
  import { statistics12, statistics5 } from '../index.api';
  ...
  const active = ref(route.query.idx || '1');
  ...
  function getList(params?) {
    if (active.value == '1') {
      ...
      return statistics12({ ...props.queryParams, ...params });
    }
  }
  ...
  const searchRefresh = (queryParams) => {
    list.value = [];
    list2.value = [];
