<template>
  <div class="question-title">{{ route.query.status === '1' ? currentQuestion.questionSort : currentIdx + 1 }}、多选题 </div>
  ...
  <div class="analysis" v-if="pageState == '1'">
    <div class="result"
      ><span class="c-red" v-if="currentQuestion.userAnswer && currentQuestion.userAnswer.length > 0">回答{{ currentQuestion.correctFlag ? '正确' : '错误'}}</span></div
    >
