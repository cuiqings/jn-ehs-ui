...
<script lang="ts" setup>
 ...
 import { submitExamApi } from '/@/views/education/student/selfStudy/url/index';
  ...
  const submit = async (back) => {
    ...
    let result: Array<{ id: number; userAnswer: string | number | Array<string> }> = [];
    questionList.value.forEach((item: any) => {
      let obj = { id: item.id, userAnswer: item.userAnswer ? item.userAnswer : '' };
      // 填空题结果组装
