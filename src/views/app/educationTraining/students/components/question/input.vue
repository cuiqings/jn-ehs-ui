<template>
  <div class="question-title">{{ route.query.status === '1' ? currentQuestion.questionSort : currentIdx + 1 }}、填空题（{{ currentQuestion.score }}分） </div>
  ...
  <div class="analysis" v-if="pageState == '1'">
    <div class="result"><span class="c-red">回答{{ currentQuestion.correctFlag ? '正确' : '错误'}} | 得分：{{ currentQuestion.userScore}}分</span></div>
