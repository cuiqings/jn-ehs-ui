...
<script lang="ts" setup>
  ...
  import { evaluateList } from '../../index.api';
  ...
  const openDetail = (item) => {
    // type 1: 签字评价 2: 教材评审
    let query = { id: item.taskId, sourceType: 2, type: 1, vettingId: item.vettingId, node: item.node };
    appStore.setActiveIdx(active.value);
    router.push({ path: '/app/teacher/evaluateDetail', query: query });
  };
</script>
