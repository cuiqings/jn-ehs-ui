...
<script lang="ts" setup>
  ...
  const props = withDefaults(
    ...
    { needBtn: true, needNotice: false, listType: 'ledger', btnShowTag: 'canHandle', immediateCheck: true, isChecked: false, tabtype: 1 }
  );
