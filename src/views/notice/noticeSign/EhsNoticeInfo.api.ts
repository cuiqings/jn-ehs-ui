...
enum Api {
  list = '/notice/ehsNoticeInfo/querySignList',
  ...
  confirmSign = '/notice/ehsNoticeInfo/confirmSign',
}
/**
 * 导出api
 * @param params
 ...
 * @param params
 */
export const confirmSign = (params, isUpdate) => {
  return defHttp.post({url: Api.confirmSign, params});
}
