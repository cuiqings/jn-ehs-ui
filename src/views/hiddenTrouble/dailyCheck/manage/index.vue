          ...
          <template v-if="toggleSearchStatus">
            <a-col :md="6" :sm="12">
              <a-form-item label="巡检周期">
                <JDictSelectTag v-model:value="queryParam.checkCycle" :show-choose-option="false" placeholder="请选择" dictCode="sk_check_cycle" />
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="12">
              <a-form-item label="计划类型">
                <JDictSelectTag
                  v-model:value="queryParam.planType"
            ...
            <a-col :md="6" :sm="12">
              <a-form-item label="执行人">
                <a-input allowClear placeholder="请输入" v-model:value="queryParam.executePersonName" />
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="12">
