<template>
  <div>
    ...
    <div class="jeecg-basic-table-form-container" @keyup.enter="searchQuery">
      <a-form ref="formRef" :model="queryParam" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-row :gutter="24">
          ...
          <a-col :md="7" :sm="12">
            <a-form-item label="区域位置（单元）">
              <a-select v-model:value="queryParam.rgLcId" allowClear placeholder="请选择">
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection" :searchInfo="queryParam">
      <template #tableTitle>
        <a-button type="primary" preIcon="ant-design:export-outlined" @click="onExportXls" v-auth="'yh:sk_yh_item:export'"> 导出</a-button>
      </template>
...
<script lang="ts" setup>
  ...
  import { getRgLcList } from '../dailyCheck/manage/manage.api';
