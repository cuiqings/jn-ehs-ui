        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="12">
            <a-form-item label="隐患来源">
              <JDictSelectTag
                v-model:value="queryParam.sourceType"
                placeholder="请选择"
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :md="6" :sm="12">
              <a-form-item label="提报人">
                <a-input allowClear placeholder="请输入" v-model:value="queryParam.reporterName" />
              </a-form-item>
            </a-col>
          </template>
...
<script lang="ts" setup>
  ...
  import { columns } from './confirm.data';
  import { getList } from './confirm.api';
  ...
  import DealDrawer from '../../randomClap/DealDrawer.vue';
