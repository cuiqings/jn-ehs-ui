          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :md="6" :sm="12">
              <a-form-item label="隐患等级">
                <JDictSelectTag
                  v-model:value="queryParam.yhLevel"
                  placeholder="请选择"
                  dictCode="yh_hidden_level"
                  :show-choose-option="false"
                  :allowClear="true"
                />
              </a-form-item>
            ...
            <a-col :md="6" :sm="12">
              <a-form-item label="防控手段">
                <JDictSelectTag
                  v-model:value="queryParam.handleMeans"
                  placeholder="请选择"
                  dictCode="yh_control_means"
                  :show-choose-option="false"
                  :allowClear="true"
                />
              </a-form-item>
...
<script lang="ts" setup>
  ...
  const queryParam = reactive({
    ...
    repairDateBegin: '',
    repairDateEnd: '',
    dutyPeopleName: undefined,
    dutyDept: undefined,
    yhType: undefined,
    handleMeans: undefined,
  });
  // loadData();
  // function loadData(){
  //  searchQuery();
