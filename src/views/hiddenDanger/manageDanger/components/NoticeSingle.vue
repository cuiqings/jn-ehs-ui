<template>
  <div id="downLoadPdf">
    ...
    <a-row style="float: right; margin-right: 44px">
      <a-col :span="24">
    ...
    >
      <tbody>
        ...
        <tr>
          <td v-if="type1 || type4" colspan="13" style="text-align: left">
            <div class="STYLE3">
              {{ typeNameTip }}
            </div>
            <div
          ...
          <td v-if="type2 || type3 || type5" colspan="6" class="STYLE3" style="text-align: left">
            <div class="STYLE3">
              {{ typeNameTip }}
            </div>
        ...
        <tr v-if="type1 || type2 || type3 || type4" style="height: 160px; border: 1px solid #000">
          ...
          <td colspan="7" class="STYLE3" style="text-align: left; border: 1px solid #000">
            <div style="margin-top: 5px; margin-left: 5px"> 接收单位签字： </div>
            <div style="width: 30px; height: 30px; margin-left: 15px">
              <a-upload
                list-type="picture-card"
                :headers="headers"
...
<script lang="ts" setup>
  ...
  watch(
    () => noticeNo.value,
    () => {
      getNoticeInfo(noticeNo.value);
    },
    {
      immediate: true,
    }
  );
  function getNoticeInfo(noticeNo) {
    defHttp.get({ url: '/notice/ehsNoticeInfo/getByNoticeNo', params: { noticeNo: noticeNo } }).then((res) => {
