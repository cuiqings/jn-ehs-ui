...
enum Api {
  list = '/hiddenDangerChecks/jnYhPlan/list',
  save = '/hiddenDangerChecks/jnYhPlan/add',
  edit = '/hiddenDangerChecks/jnYhPlan/edit',
  delete = '/hiddenDangerChecks/jnYhPlan/delete',
  deleteBatch = '/hiddenDangerChecks/jnYhPlan/deleteBatch',
