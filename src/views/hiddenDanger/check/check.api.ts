...
enum Api {
  list = '/hiddenDangerChecks/jnYhCheckItem/list',
  save = '/hiddenDangerChecks/jnYhCheckItem/add',
  edit = '/hiddenDangerChecks/jnYhCheckItem/update',
  delete = '/hiddenDangerChecks/jnYhCheckItem/delete',
  deleteBatch = '/hiddenDangerChecks/jnYhCheckItem/deleteBatch',
  exportXls = '/hiddenDangerChecks/jnYhCheckItem/exportXls',
