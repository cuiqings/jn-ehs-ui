...
enum Api {
  list = '/deviceCategory/listDeviceCategoryTree',
  save = '/deviceCategory/save',
  edit = '/deviceCategory/edit',
  deleteCategory = '/deviceCategory/delDeviceCategoryBatch',
  deleteBatch = '/deviceCategory/delDeviceCategoryBatch',
  loadTreeData = '/deviceCategory/listDeviceCategoryTree',
