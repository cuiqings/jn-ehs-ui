...
<script lang="ts" name="functional-category" setup>
//ts语法
import { ref } from 'vue';
import { BasicTable, useTable, TableAction } from '/src/components/Table';
import { useDrawer } from '/src/components/Drawer';
import CategoryModal from './components/FunctionalCategoryModal.vue';
import { useModal } from '/src/components/Modal';
import { columns } from './functionalCategory.data';
import { list, deleteCategory, batchDeleteCategory } from './functionalCategory.api';
