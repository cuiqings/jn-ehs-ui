<template>
  <a-card :bordered="false" style="height: 100%">
    <div class="j-table-operator" style="width: 100%">
      <a-button @click="syncDepartHand" type="primary">部门手动同步</a-button>
...
import { Api, deleteBatchDepart, queryDepartTreeSync, updateDepartInfoBatch } from '../depart.api';
...
function syncDepartHand() {
  updateDepartInfoBatch();
}
defineExpose({
  loadRootTreeData,
});
