<template>
  <div :class="prefixCls" class="login-background-img">
    <AppQrCode class="absolute top-4 right-6 enter-x xl:text-gray-600" :class="`${prefixCls}-action__item`" />
    <!-- <AppLocalePicker class="absolute top-4 right-4 enter-x xl:text-gray-600" :showText="false" :class="`${prefixCls}-action__item`" /> -->
    ...
    <div class="auti-logo-container">
      <img class="auti-logo-img" :src="logoImg" alt="" />
      <span class="auti-logo-title">
        {{ t('sys.login.title') }}
      </span>
    </div>
          ...
          <div class="aui-form">
            ...
            <div class="aui-formBox">
              <div class="aui-formWell">
                <div class="aui-formWelcome-title">
                  <p>{{ t('sys.login.welcome') }}</p>
                  <p>{{ t('sys.login.nav') }}</p>
                </div>
                  ...
                  <a-form ref="loginRef" :model="formData" v-if="activeIndex === 'accountLogin'" @keyup.enter.native="loginHandleClick">
                    <div class="aui-account">
                      <div class="aui-inputClear">
                        ...
                        <a-form-item>
                          <a-input class="fix-auto-fill" :placeholder="t('sys.login.userNameorWorkNumber')" v-model:value="formData.username" />
                        </a-form-item>
                      </div>
                      <div class="aui-inputClear">
...
<script lang="ts" setup name="login-mini">
  ...
  import logoImg from '/resource/img/login_logo.png';
  ...
  import AppQrCode from '/@/components/Application/src/AppQrCode.vue';
  ...
  const key = CryptoJS.enc.Utf8.parse('ehsAdmin12345678'); // 密钥
  const iv = CryptoJS.enc.Utf8.parse('2024EHSManage123'); // 偏移量
  // aes加密
  const Encrypt = (word) => {
