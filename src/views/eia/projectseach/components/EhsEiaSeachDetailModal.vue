<template>
  <BasicModal v-bind="$attrs" @register="registerModal" destroyOnClose :title="title" :width="1000"
    ...
    <a-row style="margin-top: 10px">
      <div style="margin-left: 50px;white-space:pre">
        {{ statusName }}
      </div>
    </a-row>
        ...
        <a-row>
          ...
          <div class="ant-col ant-col-12">
            <div class="ant-row ant-form-item" style="row-gap: 0px;">
              ...
              <div class="ant-col ant-col-xs-12 ant-col-sm-12 asdasdasdasdasdant-form-item-control"
                   style="width: calc(100% - 150px);">
                <div class="ant-form-item-control-input">
                  <div class="ant-form-item-control-input-content">
                    <div style="display: flex;">
...
import {applyFormSchema} from '../EhsEiaSeach.data';
import {operate} from '../EhsEiaSeach.api';
...
const [registerModal, {setModalProps, closeModal}] = useModalInner(async (data) => {
  ...
  if (ehsEiaInfoForm.ehsEiaInfo.status == '0') {
    ...
    if (ehsEiaInfoForm.ehsEiaInfo.status == '1') {
      ...
      key5Show.value = false;
      activeKey.value = '4';
      statusName.value = "环评中" + "    " + ehsEiaInfoForm.ehsEiaInfo.eiaApplyDt + "    " + ehsEiaInfoForm.ehsEiaInfo.eiaProjectName;
      ...
      key5Show.value = false;
      activeKey.value = '4';
      statusName.value = "环评完成" + "    " + ehsEiaInfoForm.ehsEiaInfo.eiaEndDt + "    " + ehsEiaInfoForm.ehsEiaInfo.eiaProjectName;
      ...
      key5Show.value = true;
      activeKey.value = '5';
      statusName.value = "验收中" + "    " + ehsEiaInfoForm.ehsEiaInfo.acceptanceCheckDt + "    " + ehsEiaInfoForm.ehsEiaInfo.eiaProjectName;
      ...
      key5Show.value = true;
      activeKey.value = '5';
      statusName.value = "验收完成" + "    " + ehsEiaInfoForm.ehsEiaInfo.acceptanceEndDt + "    " + ehsEiaInfoForm.ehsEiaInfo.eiaProjectName;
    }
  }
