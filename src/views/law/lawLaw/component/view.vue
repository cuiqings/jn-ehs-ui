  ...
  <div class="home-view">
    <div class="home-view_breadcrumb"
      ><a-breadcrumb separator=">">
        当前位置：<a-breadcrumb-item @click="onBack" style="cursor: pointer">{{ breadcrumbText }}</a-breadcrumb-item>
        <a-breadcrumb-item>{{ list.fileName }}</a-breadcrumb-item>
      </a-breadcrumb>
      <a-button @click="onBack"> 关闭 </a-button>
    </div>
...
<script lang="ts" name="law-home-view" setup>
  ...
  import { details, collect, collectCancel } from '../url/index';
