      ...
      <a-row style="height: 100%">
        ...
        <a-col :span="18" style="height: 100%">
          <div class="home-content_search">
            ...
            <div class="home-content_search_div">
              <span class="home-content_search_div_lable">行业分类：</span>
              <div class="legalHierarchySelect">
                <j-tree-select1
                  v-model:value="tradeStandardCategortCode"
                  style="width: calc(40% - 90px); margin-left: 5px"
                  :tree-data-arr="neic"
                  @change="neicChange"
                />
                <div style="width: calc(40% + 20px)">
                  <span class="home-content_search_div_lable">归口单位：</span>
                  <a-input style="width: calc(100% - 110px)" placeholder="请输入" v-model:value="queryParams.technicalOmmittees" :maxlength="100" />
                </div>
              </div>
            </div>
            <div class="home-content_search_div">
...
<script lang="ts" name="law-lawLs" setup>
  import { useContent } from '../lawLaw/hooks/useContent';
  import { Empty } from 'ant-design-vue';
  import { Pagination } from 'ant-design-vue';
  import { JTreeSelect1 } from '/@/components/Form';
  import { neic } from '../lawManage/hooks/useStatic';
