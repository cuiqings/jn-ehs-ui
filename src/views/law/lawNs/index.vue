        ...
        <a-col :span="18" style="height: 100%">
          <div class="home-content_search">
            ...
            <div class="home-content_search_div">
              ...
              <div class="legalHierarchySelect" style="margin-left: 6px">
                <a-input style="width: 100%" placeholder="请输入" v-model:value="queryParams.technicalOmmittees" :maxlength="100" />
              </div>
            </div>
            <div class="home-content_search_div">
...
<script lang="ts" name="law-lawNs" setup>
