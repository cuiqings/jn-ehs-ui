            ...
            <a-col :md="6" :sm="12">
              <a-form-item label="隐患状态">
                <a-select v-model:value="queryParam.yhStatus" allowClear placeholder="请选择">
                  <a-select-option value="0">系统自动退回</a-select-option>
...
<script lang="ts" setup name="daily-hidden-confirm">
  import { ref, reactive, computed } from 'vue';
  import { BasicTable, TableAction } from '/@/components/Table';
  import { columns } from '../common/data';
  import { getConfirmList } from '../common/api';
  ...
  function orgCodeChange(e: any) {
    console.log('e', e);
    departOptions.value = [];
    queryParam.repairDepart = undefined; //  reset city value
