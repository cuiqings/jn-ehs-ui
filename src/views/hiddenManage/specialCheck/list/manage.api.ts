...
enum Api {
  list = '/yh/skYhSpecialCheck/list',
  save = '/yh/skYhSpecialCheck/add',
  edit = '/yh/skYhSpecialCheck/edit',
  delete = '/yh/skYhSpecialCheck/delete',
  deleteBatch = '/yh/skYhSpecialCheck/deleteBatch',
