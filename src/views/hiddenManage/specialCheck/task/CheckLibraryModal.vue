...
<script lang="ts" setup>
  ...
  import { checkLibraryColumns, searchCheckLibraryFormSchema } from './task.data';
  import { getSpecialCheckList } from './task.api';
  ...
  const { tableContext } = useListPage({
    tableProps: {
      ...
      beforeFetch: (info: Record<string, any>) => {
        info['checkType'] = dataParams.value.checkType;
        return info;
      },
