...
enum Api {
  ...
  save = '/yh/skYhSpecialTask/add',
  edit = '/yh/skYhSpecialTask/edit',
  delete = '/yh/skYhSpecialTask/delete',
  deleteBatch = '/yh/skYhSpecialTask/deleteBatch',
  ...
  specialCheckList = '/yh/skYhSpecialCheck/list',
  specialCheckItemList = '/yh/skYhSpecialCheck/getItemList',
  riskLibraryList = '/yh/skYhSpecialTask/getRiskListByRange',
  riskLibraryListByIds = '/rk/skRkPoint/list',
}
...
export const getSpecialCheckList = (params) => {
  return defHttp.get({ url: Api.specialCheckList, params });
}
export const getSpecialCheckItemList = (params) => {
  return defHttp.get({ url: Api.specialCheckItemList, params });
}
export const getRiskLibraryList = (params) => {
  return defHttp.get({ url: Api.riskLibraryList, params });
}
export const getRiskLibraryListByIds = (params) => {
  return defHttp.get({ url: Api.riskLibraryListByIds, params });
}