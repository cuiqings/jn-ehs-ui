<template>
  <div class="p-1">
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      <template #tableTitle>
        <a-button type="primary" v-auth="'occupationalHealth:checkfile:add'" preIcon="ant-design:plus-outlined" @click="add">新增</a-button>
      </template>
...
<script lang="ts" name="occupationalHealth-checkfile" setup>
